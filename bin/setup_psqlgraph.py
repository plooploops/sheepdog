...
from gdcdatamodel.models import *  # pylint: disable=W0614,W0401
from psqlgraph import create_all, Node, Edge


def try_drop_test_data(  # nosec pylint: disable=R0913
    user,
    database="postgres",
    root_user="postgres",
    host="",
...
def setup_database(  # nosec pylint: disable=R0913,R0914
    user,
    password,
    database,
    root_user="postgres",
...
def create_tables(
    host, port, user, password, database, use_ssl=False
