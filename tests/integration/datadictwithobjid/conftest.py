...
def pg_config(use_ssl=False, isolation_level=None): # pylint: disable=W0621
    test_host = (
...
@pytest.fixture
def pg_driver(request, client, use_ssl, isolation_level): # pylint: disable=W0621
    pg_driver = PsqlGraphDriver( # pylint: disable=W0621
